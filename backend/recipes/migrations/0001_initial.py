# Generated by Django 2.2.16 on 2022-01-17 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Название')),
                ('color', models.CharField(choices=[('#0000FF', 'Синий'), ('#008000', 'Зеленый'), ('#FFFF00', 'Желтый')], max_length=7, unique=True, verbose_name='Цвет')),
